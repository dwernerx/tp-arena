...
class TestCGPs {
	...
	Punto puntoEnLaComuna12
	Punto puntoEnOtraComuna12
	
	ServicioCGP rentas
	ServicioCGP servicioSocial
	ServicioCGP direccionGeneralDeLaMujer
	ServicioCGP registroCivil
	ServicioCGP tesoreria
	...
	def void init() {
		...
		.agregarZonaComuna(new Poligono()=>[
		...
		.agregarZonaComuna(new Poligono()=>[
				add(new Punto(-34.598014, -58.411913))
				add(new Punto(-34.599623, -58.392947))
				add(new Punto(-34.627218, -58.391205))
				add(new Punto(-34.630324, -58.411834))
				])
		...
		.agregarZonaComuna
		(new Poligono()=>[
				add(new Punto(-34.640172, -58.423435))
				add(new Punto(-34.638036, -58.411236))
				add(new Punto(-34.597959, -58.411927))
				add(new Punto(-34.594439, -58.430157))
				])
		.agregarNumeroComuna("5").build	
		
		comuna6 = new ComunaBuilder()
		.agregarZonaComuna(new Poligono()=>[
				add(new Punto(-34.607374, -58.462677))
				add(new Punto(-34.602668, -58.433401))
				add(new Punto(-34.626943, -58.426822))
				add(new Punto(-34.630569, -58.451768))
				])		
		...
		.agregarZonaComuna(
			...
			new Poligono()=>[
				add(new Punto(-34.634291, -58.366412))
				add(new Punto(-34.639199, -58.363601))
				add(new Punto(-34.635068, -58.355576))
				add(new Punto(-34.631466, -58.359395))
				])
				
		.agregarNumeroComuna("12").build	
		
		puntoEnLaComuna12 = new Punto(-34.633443, -58.362524)
		puntoEnOtraComuna12 = new Punto(-34.600129, -58.415931)
...
//		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("07:30").agregarHoraFin("15:30").build)
		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(7, 30, 0)).agregarHoraFin(new LocalTime(15, 30, 0)).build)
		.build
...
//		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("19:00").build)
		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(8, 0, 0)).agregarHoraFin(new LocalTime(19, 0, 0)).build)
		.build
...
//		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("09:00").agregarHoraFin("21:00").build)
		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(9, 0, 0)).agregarHoraFin(new LocalTime(21, 0, 0)).build)
		.build
...
//		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("08:30").agregarHoraFin("20:30").build)
		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(8, 30, 0)).agregarHoraFin(new LocalTime(20, 30, 0)).build)
		.build
...
//		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("07:00").agregarHoraFin("13:00").build)
		.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(7,0,0)).agregarHoraFin(new LocalTime(13,0,0)).build)
		.build
	
		
				
		sedeComuna2 = new CGPBuilder()
		.agregarComuna(new ComunaBuilder().agregarZonaComuna(new Poligono()=>[
				add(new Punto(-34.569901, -58.399222))
				add(new Punto(-34.579503, -58.376716))
				add(new Punto(-34.599284, -58.386868))
				add(new Punto(-34.597805, -58.415952))
