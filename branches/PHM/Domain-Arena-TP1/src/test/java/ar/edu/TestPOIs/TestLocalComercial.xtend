...
class TestLocalComercial {
	...
	Punto puntoAMenosDeUnaCuadra
	Punto puntoADosCuadras
	Punto puntoAMasDeCincoCuadras
	...
	def void init() {		
		...
		puntoAMenosDeUnaCuadra = new Punto(-34.579200, -58.527941)
		puntoADosCuadras = new Punto(-34.577521, -58.530017)
		puntoAMasDeCincoCuadras = new Punto(-34.575587, -58.532485)
...
//					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("09:30").agregarHoraFin("20:00").build)
					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(9,30,0)).agregarHoraFin(new LocalTime(20,0,0)).build)
...
//					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("20:00").build)
					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(8,0,0)).agregarHoraFin(new LocalTime(20,0,0)).build)
...
//					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("21:00").build)
					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(8,0,0)).agregarHoraFin(new LocalTime(21,0,0)).build)
...
//					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("09:30").agregarHoraFin("20:30").build)
					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(9,30,0)).agregarHoraFin(new LocalTime(20,30,0)).build)
...
//					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("10:00").agregarHoraFin("20:00").build)
					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(10,0,0)).agregarHoraFin(new LocalTime(20,0,0)).build)
...
//					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("09:30").agregarHoraFin("21:30").build)
					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(9,30,0)).agregarHoraFin(new LocalTime(21,30,0)).build)
...
//					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("09:15").agregarHoraFin("20:45").build)
					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(9,15,0)).agregarHoraFin(new LocalTime(20,45,0)).build)
...
//					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio("08:00").agregarHoraFin("16:30").build)
					.agregarHorario(new HorarioDeAtencionBuilder().agregarHoraInicio(new LocalTime(8,0,0)).agregarHoraFin(new LocalTime(16,30,0)).build)
